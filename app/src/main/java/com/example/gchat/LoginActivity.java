...
public class LoginActivity extends AppCompatActivity {
    ...
    TextView nothaveaccount,recover_pass;
    Button loginbtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recover_pass=findViewById(R.id.forgottv);
        googleloginbtn=findViewById(R.id.googleLogin);

        loginbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String email=aEmailet.getText().toString();
                String password=aPasswordet.getText().toString();
